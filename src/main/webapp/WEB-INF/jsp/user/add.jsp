    ...
    <script>
        $(function () {
            ...
            $("input[name='username']").blur(function () {
                ...
                //3.ajax请求对用户名做重复的校验
                $.post(
                    "${pageContext.request.contextPath}/user/checkUsername.do",
...
<!--显示表单内容-->
<div id=MainArea>
    <form action="${pageContext.request.contextPath}/user/save.do" method="post" id="saveForm">
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    ...
                    <tr><td>登录名</td>
                        <td><input type="text" name="username" class="InputStyle"/> *<span id="message"></span>
                            （登录名要唯一）
                        </td>
                    </tr>
                    <tr><td>性别</td>
                        <td><input type="RADIO" checked="checked" name="sex" value="男" id="male"/><label for="male">男</label>
